export default function Contact() {
    return (
        <div className={"flex flex-col h-full mb-24 items-center justify-center max-w-[1000px] w-full"}>
            ...
            <h3 className={"slate font-[600] mb-6 text-6xl"}>Get In Touch</h3>
            ...
            <a href={"mailto:ishwarjagdale50@gmail.com"} className={" accent hover-btn accent-border border p-4 px-8 text-md font-monospace rounded"}>
                Say Hello
            </a>
        </div>
    )
