export default function Home() {
    return (
        <div className={"flex flex-col h-full mb-24 justify-center max-w-[1000px] w-full"}>
            ...
            <span className={"text-7xl font-[Poppins] font-[600] slate mb-2"}>Ishwar J.</span>
            <span className={"text-7xl font-[Poppins] font-[600] opacity-60 slate tracking-tight"}>I build open-source apps.</span>
            <p className={"py-8 slate text-lg opacity-60 max-w-[600px]"}>
